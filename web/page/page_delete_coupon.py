...
class PageDeleteCoupon(WebBase):
    # 点击推广管理
    ...
    def page_click_delete_btn(self):
        self.base_js_click(page.li_delete_btn)

    def page_exist_coupon(self, name):
        return self.web_base_goods_is_exist(name, name)

    # 组合查找优惠券业务
    def page_delete_coupon(self, name, text, status):
